    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('var_name', models.CharField(blank=True, help_text='Name of the variable (e.g., Voltage, Power)', max_length=100, null=True)),
                ('unit', models.CharField(blank=True, help_text='Measurement unit (e.g., V, A, W)', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_in_homepage', models.BooleanField(default=False, help_text='Show this variable in the homepage')),
                ('order', models.PositiveIntegerField(default=0)),
                ('conversion_factor', models.CharField(blank=True, default='1', help_text='Factor to convert raw data to physical value', null=True)),
                ('obis_code', models.CharField(blank=True, default='', help_text='Address of the mapped value', null=True)),
                ('column_idx', models.IntegerField(default=1, help_text='Column of the profile generic to read')),
                ('device', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dlms_variables', to='user_devices.device')),
            ],
            options={
                'ordering': ['order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_in_homepage', models.BooleanField(default=False, help_text='Show this variable in the homepage')),
                ('order', models.PositiveIntegerField(default=0)),
                ('address', models.CharField(blank=True, default='', help_text='Address of the mapped value', null=True)),
                ('conversion_factor', models.CharField(blank=True, default='1', help_text='Factor to convert raw data to physical value', null=True)),
                ...
                ('device', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='modbus_variables', to='user_devices.device')),
            ],
            options={
                'ordering': ['order'],
                'abstract': False,
